...
class Canvas(app.Canvas):
    def __init__(self, surface, bed, new_waves_class=None, size=(1000, 1000), sky_img_path="D:\Documents\water-surface\water-surface/fluffy_clouds.png", bed_img_path="D:\Documents\water-surface\water-surface/seabed.png"):
